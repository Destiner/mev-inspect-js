...
import type { LiquidityDeposit, Swap } from '../../src/index.js';
import type { Sandwich } from '../../src/mev/sandwiches.js';
import { getSandwiches } from '../../src/mev/sandwiches.js';
  ...
  test('skip irrelevant swaps detecting a sandwich', () => {
    const swaps: Swap[] = [
      ...
      },
      {
        ...
        transaction: {
          from: '0x6aa22a902ebad03cef40454f4afd2423270c11a9',
  ...
  test('sandwich', () => {
    const swapsA: Swap[] = [
      {
        ...
        transaction: {
          from: '0x16986dc82b24987f66939635137e25836df2ea61',
      ...
      },
      {
        ...
        transaction: {
          from: '0x4ecde565958dd14ac37dcc9d3d08125f17c7aaaf',
      ...
      },
      {
        ...
        transaction: {
          from: '0xf27696c8bca7d54d696189085ae1283f59342fa6',
    ...
    const swapsB: Swap[] = [
      ...
      },
      {
        ...
        transaction: {
          from: '0x09cf91d5e137cf047eb9e0551ceb18239b46d3dd',
  ...
  test('sandwich with non-ether profit asset', () => {
    const swaps: Swap[] = [
      ...
      },
      {
        ...
        transaction: {
          from: '0xd130a09cfd40c2a35b0f6e14955922aa6f782732',
    ...
    const swaps: Swap[] = [
      {
        ...
        transaction: {
          from: '0xca23c67974f9db8a9a9f2a3842ace05d0e2d1137',
      ...
      },
      {
        ...
        transaction: {
          from: '0x50efbf12580138bc263c95757826df4e24eb81c9',
      ...
      },
      {
        ...
        transaction: {
          from: '0xc16414ac1fedfdac4f8a09674d994e1bbb9d7113',
    ...
    const swapsA: Swap[] = [
      {
        ...
        transaction: {
          from: '0x68d6636e7b5a5facf0a45f52c1f2298b1369cd84',
      ...
      },
      {
        ...
        transaction: {
          from: '0x007eadd74bfa83347b05bf470a7107a68df285c2',
    ...
    const swapsB: Swap[] = [
      {
        ...
        transaction: {
          from: '0x520db7c2161aa43fb7eb1bd87c40a084de2c5008',
        ...
        assetIn: {
          type: 'erc20',
          address: '0x679a0b65a14b06b44a0cc879d92b8bb46a818633',
        },
    ...
    const swapsC: Swap[] = [
      {
        ...
        transaction: {
          from: '0xdd07249e403979bd79848c27aa5454c7e66bdee7',
        ...
        assetOut: {
          type: 'erc20',
          address: '0x6755f01e2a13962ee79e17d6f36cf6a2153f3aae',
        },
      ...
      },
      {
        ...
        transaction: {
          from: '0xa43c750d5de3bd88ee4f35def72cf76afebec274',
