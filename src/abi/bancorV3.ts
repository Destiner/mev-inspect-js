const abi = [
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'contract IPoolCollection', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      { internalType: 'contract Token[]', name: 'tokens', type: 'address[]' },
      {
        internalType: 'contract IPoolCollection',
        name: 'poolCollection',
        type: 'address',
  ...
  {
    inputs: [
      { internalType: 'contract Token[]', name: 'pools', type: 'address[]' },
      {
        internalType: 'contract IPoolCollection',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: 'maxSourceAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'deadline', type: 'uint256' },
      { internalType: 'address', name: 'beneficiary', type: 'address' },
    ],
